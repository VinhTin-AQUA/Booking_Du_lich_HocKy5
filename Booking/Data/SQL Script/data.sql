...
The last stop is Flan Cake for dessert in Dist 4.~Thời gian: 4 tiếng (xấp xỉ)\nBao gồm vé vào cửa~
	   ...
	   Ho Thi Ky Flower Market~Ho Thi Ky Flower Marke: Ho Thi Ky Flower Market is the place which supplies the fresh and beautiful flowers with quite low a price in Ho Chi Minh City . We will walk in to the market and stop at street food market behind to try the best Saigon Pizza and the most famous local snack : Banana Crispy Cracker. ( promise you will love it )~Thời gian: 40 phút (xấp xỉ)\nBao gồm vé vào cửa~
	   Nguyen Thien Thuat Apartment Buildings~we drive to Nguyen Thien Thuat - the oldest apartment in Saigon. Climb up to the buildings and see the contrasting architecture between the modern and the traditional. We also visit a pagoda which was built inside an old apartment.~Thời gian: 40 phút (xấp xỉ)\nBao gồm vé vào cửa~
...
INSERT INTO Tour(TourName,TourAddress,Overview,Schedule,DepartureLocation,DropOffLocation,PhotoPath) VALUES(
	...
	N'[Standard Cooking Class with Cyclo Tour~8:30 am: Begin your day with a hotel pick-up and enjoy a 30-minute cyclo trip. It''s the start of your exploration of the highlights in Ho Chi Minh\n10:30 am: Transition to Cyclo Resto Restaurant for an immersive cooking class. Here, you''ll acquire the skills to craft delicious Vietnamese dishes\n11:30 am: Revel in your culinary accomplishments. As a special treat, indulge in Vietnamese Egg coffee for dessert\n12:00 pm: Conclude this memorable experience~
	   Premium Cooking Class with Cyclo Tour & Wet Market Trip~8:00 am: Pick up at the hotel and enjoy a 30-minute cyclo trip\n8:30 am: Arrive at a designated meeting point for a training session before the market trip\n8:45 am: Embark on the market trip with a tour guide. It''s the perfect time for you to practice how to pay in Vietnamese Dong, bargain with local vendors, and choose the freshest ingredients\n9:15 am: Begin the class. Learn essential skills for creating authentic Vietnamese dishes, including knife techniques, marinating methods, and decoration Prepare delicious dishes from the menu\n11:30 am: Savor your culinary achievements, and don''t forget to indulge in a special reward: Vietnamese Egg coffee for dessert\n12:00 pm: End of the experience]',
...
INSERT INTO TourCategory VALUES (8,9);
